		   ...
		   <table class="tbl-full">
		     	<tr>
                   ...
                   //query to get all admin
		     	         ...
		     	         if($res==TRUE)
		     	         {
                          //COUNT ROWS TO CHECK whether we have data in database of not
		     	         	      $count = mysqli_num_rows
		     	         	      ($res); // function to get all the rows in database
                           ...
                           $sn=1; //create the variable and assign the value
		     	            ...
		     	            if($count>0)
		     	            {
                                  ...
                                  //and while loop will run us log as we have data in database
